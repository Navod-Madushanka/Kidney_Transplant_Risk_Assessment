...
sensitization — an antibody at MFI 1500 used to halt the transplant outright
while not even counting toward the patient's sensitization profile.

DEFAULT_MFI_CUTOFF is intentionally left alone and NOT unified with this
module: it answers a different clinical question (how sensitized is this
...
flagged for a clinician's desensitization-protocol review. Strong DSA still

  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        {/* Mounted above every authenticated route (dashboard, wizard, and
            the standalone report page below) so a background extraction
            job's progress notification stays visible no matter where the
            doctor navigates -- see BackgroundJobsProvider's docstring. */}
        <Route element={<BackgroundJobsProvider><Outlet /></BackgroundJobsProvider>}>
